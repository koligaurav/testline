...
- **Progress Circle**: Visual representation of quiz completion using a circular progress bar.
- **Skip Option**: Skip the current question and move to the next.
- **Timer**: A 15-minute countdown timer for the quiz.
- **Question Status**: Indicates whether each question is attempted or skipped.
